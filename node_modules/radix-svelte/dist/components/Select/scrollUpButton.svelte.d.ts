...
export type ScrollUpButtonProps = typeof __propDef.props;
export type ScrollUpButtonEvents = typeof __propDef.events;
export type ScrollUpButtonSlots = typeof __propDef.slots;
export default class ScrollUpButton extends SvelteComponentTyped<ScrollUpButtonProps, ScrollUpButtonEvents, ScrollUpButtonSlots> {
}
export {};
