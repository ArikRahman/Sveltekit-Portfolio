...
export type ItemIndicatorProps = typeof __propDef.props;
export type ItemIndicatorEvents = typeof __propDef.events;
export type ItemIndicatorSlots = typeof __propDef.slots;
export default class ItemIndicator extends SvelteComponentTyped<ItemIndicatorProps, ItemIndicatorEvents, ItemIndicatorSlots> {
}
export {};
