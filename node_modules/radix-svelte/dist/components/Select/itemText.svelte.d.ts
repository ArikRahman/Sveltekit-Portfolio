...
export type ItemTextProps = typeof __propDef.props;
export type ItemTextEvents = typeof __propDef.events;
export type ItemTextSlots = typeof __propDef.slots;
export default class ItemText extends SvelteComponentTyped<ItemTextProps, ItemTextEvents, ItemTextSlots> {
}
export {};
