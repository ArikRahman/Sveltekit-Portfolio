...
export type ToggleGroupRootProps = BaseProps<'div'> & (SingleToggleGroupRootProps | MultipleToggleGroupRootProps) & {
    disabled?: boolean;
    rovingFocus?: boolean;
    loop?: boolean;
...
export declare const getToggleGroupRootContext: () => import("svelte/store").Writable<ToggleGroupRootContext>;
export declare const getToggleGroupItemCollection: () => import("svelte/store").Writable<HTMLElement[]>;
