...
export declare const getRootContext: () => import("svelte/store").Writable<SwitchRootContext>;
export declare function getState(checked: boolean | undefined): "checked" | "unchecked";
