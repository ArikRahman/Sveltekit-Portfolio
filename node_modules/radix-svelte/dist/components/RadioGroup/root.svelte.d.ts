...
export declare const getRadioGroupRootContext: () => import("svelte/store").Writable<RadioGroupRootContext>;
export declare const getRadioGroupItemCollection: () => import("svelte/store").Writable<HTMLElement[]>;
