...
export declare const getRootCtx: () => import("svelte/store").Writable<AccordionContext>;
export declare const getTriggerCollection: () => import("svelte/store").Writable<HTMLElement[]>;
