...
export type ActionProps = typeof __propDef.props;
export type ActionEvents = typeof __propDef.events;
export type ActionSlots = typeof __propDef.slots;
export default class Action extends SvelteComponentTyped<ActionProps, ActionEvents, ActionSlots> {
}
export {};
