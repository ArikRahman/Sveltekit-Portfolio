    ...
    <div class="w3-third">
      ...
      <div class="w3-white w3-text-grey w3-card-4">
        ...
        <div class="w3-container">
          <p><i class="fa fa-briefcase fa-fw w3-margin-right w3-large" style="color:rgb(80,0,0);"></i>Data Engineer</p>
          <p><i class="fa fa-home fa-fw w3-margin-right w3-large" style="color:rgb(80,0,0);"></i>Katy, TX</p>
          <p><i class="fa fa-envelope fa-fw w3-margin-right w3-large " style="color:rgb(80,0,0);"></i>arik@tamu.edu</p>
          <p><i class="fa fa-phone fa-fw w3-margin-right w3-large " style="color:rgb(80,0,0);"></i>832-709-3931</p>
          <hr>

          <p class="w3-large"><b><i class="fa fa-asterisk fa-fw w3-margin-right " style="color:rgb(80,0,0);"></i>Skills</b></p>
          <p>Web Development</p>
